...
<% String webAppName = "template-two"; %>
...
<head>
	...
	<!-- Favicon  -->
    <link rel="icon" href="/<%= webAppName %>/static/images/favicon.png">
</head>
                    ...
                    <div class="col-lg-6 col-xl-7">
                        <div class="image-container">
                            <div class="img-wrapper">
                                <img class="img-fluid" src="/<%= webAppName %>/static/images/header-software-app.png" alt="alternative">
                        ...
                        <div class="swiper-container image-slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img class="img-fluid" src="/<%= webAppName %>/static/images/customer-logo-1.png" alt="alternative">
                                </div>
                                <div class="swiper-slide">
                                	<img class="img-fluid" src="/<%= webAppName %>/static/images/customer-logo-2.png" alt="alternative">
                                </div>
                                <div class="swiper-slide">
                                	<img class="img-fluid" src="/<%= webAppName %>/static/images/customer-logo-3.png" alt="alternative">
                                </div>
                                <div class="swiper-slide">
                                	<img class="img-fluid" src="/<%= webAppName %>/static/images/customer-logo-4.png" alt="alternative">
                                </div>
                                <div class="swiper-slide">
                                	<img class="img-fluid" src="/<%= webAppName %>/static/images/customer-logo-5.png" alt="alternative">
                                </div>
                                <div class="swiper-slide">
                                	<img class="img-fluid" src="/<%= webAppName %>/static/images/customer-logo-6.png" alt="alternative">
                                </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="/<%= webAppName %>/static/images/description-1.png" alt="alternative">
                        </div>
                        <div class="card-body">
